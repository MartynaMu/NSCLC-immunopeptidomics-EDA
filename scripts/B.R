...
write_xlsx(filtered_slim, "data/filtered/tumor.xlsx")
...
ggplot(filtered_slim, aes(Peptide.Length)) + 
  ...
  labs(title = "Length distribution of all identified peptides", 
       subtitle = "Acid elution of tumor, all patients", 
       x = "Peptide length (AA)")
